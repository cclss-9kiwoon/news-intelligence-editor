...
export function SettingsProvider({ children }: { children: ReactNode }) {
  ...
  const value: Ctx = {
    ...
    setModel, setFastModel, setLlmBackend, setAgentInboxCode, setKhalaInboxCode, setActiveCategoryId, addCategory, updateCategory, removeCategory, setArticleWindow,
